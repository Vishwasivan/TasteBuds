...
import { getRecipeFromMistral } from './huggingface.js'
...
export default function Main(){
    ...
    async function makeRecipe(){
        const genertedRecipe = await getRecipeFromMistral(ingredient)
        ...
        <div className="form-input">
            ...
            <section>
                <div className="get-recipe-container">
                    ...
                    <button onClick={() => {makeRecipe(); document.getElementById('loader').style.display = 'block';}}>Get a recipe</button>
                </div>
            </section> }
